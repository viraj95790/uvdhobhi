        ...
        <div class="container" style="padding-bottom: 30px;">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 text-center">
                    <img src="images/thanksicon.png" class="img-responsive thankyouimg" />
                    <h3 class="section-title">Thanks for confirming your order.</h3>
                    <b>You're all set!</b>
                    <div class="otpback">
                        <p>ORDER #: 173245</p>
                    </div>
                    <p>Thank you for being awesome, we hope you enjoy your booking.<br />Our Delco team reach you ASAP!</p>
