...
$(function() {
  ...
  HIS.global = {
    ...
    init: function() {
      HIS.global.deviceSize();
      HIS.global.layout();
      HIS.global.animsition();
    },
  ...
  HIS.navbar = {
    ...
    init: function() {
      HIS.navbar.menu();
      HIS.navbar.ripple();
      HIS.navbar.removeRipple();
      HIS.navbar.collapse();
      HIS.navbar.offcanvas();
    },
  ...
  HIS.extra = {
    ...
    init: function() {
      HIS.extra.sparklineChart();
      HIS.extra.slimScroll();
      HIS.extra.daterangePicker();
      HIS.extra.easypiechart();
      HIS.extra.chosen();
      HIS.extra.toggleClass();
      HIS.extra.colorpicker();
      HIS.extra.touchspin();
      HIS.extra.datepicker();
      HIS.extra.animateProgress();
      HIS.extra.counter();
      HIS.extra.popover();
      HIS.extra.tooltip();
      HIS.extra.splash();
    ...
    daterangePicker: function() {
      ...
      if ($pickDateEl.length > 0) {
        $pickDateEl.each(function() {
          ...
          element.find('span').html(moment().subtract(30, 'days').format('MMMM D, YYYY') + ' - ' + moment().format('MMMM D, YYYY'));
  ...
  HIS.isMobile = {
    ...
    any: function() {
      return (HIS.isMobile.Android() || HIS.isMobile.BlackBerry() || HIS.isMobile.iOS() || HIS.isMobile.Opera() || HIS.isMobile.Windows());
    }
  };
  ...
  HIS.documentOnResize = {

		init: function(){

      var t = setTimeout( function(){

        HIS.documentOnReady.setSidebar();
        HIS.navbar.removeRipple();
  ...
  HIS.documentOnReady = {
      ...
      HIS.global.init();
			HIS.header.init();
      HIS.navbar.init();
      HIS.documentOnReady.windowscroll();
      HIS.tiles.init();
      HIS.extra.init();
      HIS.documentOnReady.setSidebar();
		},
  ...
  // initializing
  //!!!!!!!!!!!!!
  $(document).ready( HIS.documentOnReady.init );
  $window.load( HIS.documentOnLoad.init );
  $window.on( 'resize', HIS.documentOnResize.init );
