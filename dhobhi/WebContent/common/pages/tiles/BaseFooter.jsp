  <!-- Begin Footer -->
    <div class="section-footer footer-wrap bg-dark">
        <div class="container footer center">
            <div class="row">
                <div class="col-md-3">
                    <h4>Company Info</h4>
                    <p>PDDR Medical Products & Services(I) Pvt.LTD</p>
                </div>
                <div class="col-md-3">
                    <h4>Contact Info</h4>
                    <p><i class="fa fa-map-pin" aria-hidden="true"></i> 122/2 Mouja Sangam Opp. Ddasaheb Kalmegh Dental College,Wanadongri, Hingna Road, Nagpur -441110</p>
                    <p><i class="fa fa-envelope-open-o" aria-hidden="true"></i> info@dhobhitech.com</p>
                    <p><i class="fa fa-calendar-o" aria-hidden="true"></i> 9am - 6 pm monday / saturday</p>
                </div>
                <div class="col-md-3">
                    <h4>Support</h4>
                    <p><a href="#">Faq</a></p>
    ...
    <div class="section-copyright bg-dark">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <p>The Laundry. All rights reserved &copy; 2017</p>
                </div>
                <div class="col-md-6">
