...
function TOOLS_CLASS(){
	...
	this.draw_helpers = function(){
		...
		for(var i in ACTION_DATA){
			...
			html += ' style="background: #E7E7E7 url(\'minipaint/img/'+ACTION_DATA[i].icon[0]+'\') no-repeat '+ACTION_DATA[i].icon[1]+'px '+ACTION_DATA[i].icon[2]+'px;"';
	...
	this.toggle_color_select_onload = function(){
		...
		img.src = 'minipaint/img/colors.png';
		}
