				...
				<div class="modal-header bg-primary">
					...
					<div class="car-info">
						<ul>
							...
							<li id="">Discipline: <span id="diciplinez">Nephrologist</span></li>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					...
					<div class="car-info">
						<ul>
							<li><h4 class="modal-title" id="myModalLabel">Block Slot</h4></li>
				...
				<div class="modal-body padd0">
					<s:form action="saveNotAvailableSlot" id="notavailable_form"
						...
						<div class="col-lg-12 hidden-sm hidden-xs" id="apmtheading" >
						 ...
						 <div class="collapse" id="blockslotcoll">
							...
							<%-- 	<s:checkboxlist label="" list="weekNameList" 
	   							...
	   							<input  type="checkbox" id="blockWeekName-4" > <label>Thurdday</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="col-lg-3 col-md-3 col-sm-3 text-right col-md-5">Room:</div>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="col-lg-3 col-md-3 col-sm-3 text-right">
								<label class="red">*</label>Appointment Duration:
							</div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 mdscr md9">
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 dtd padimp iconsizlg2" id="clientarrived" >
							<div class="thumbnail" id="clienthasarrived"  onclick="clienthasarrived(1)" style="cursor: pointer;">
						      ...
						      <div class="caption"><p align="center" class="dtdf">Client has Arrived</p></div>
					    	</div>
						</div> 
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 padimp iconsizlg2" id="clientisbeingseen">
							<div class="thumbnail" id="clientseen" onclick="setClientIsBeingSeen(2)" style="cursor: pointer;">
						      ...
						      <div class="caption"><p align="center" class="dtdf">Client is Being Seen</p></div>
					    	</div>
						</div>
						...
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 dtd padimp iconsizlg2" id="clientdidnotcome">
							<div class="thumbnail" id="dna" onclick="setClientDidNotCome()" style="cursor: pointer;">
						      ...
						      <div class="caption"><p align="center" class="dtdf" id="dnatextid">Client Did Not Attend</p></div>
					    	</div>
						</div>
						...
						<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6 dtd padimp iconsizlg2" >
							...
							<!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 dtd padimp" >
						
							<div class="thumbnail" id="" onclick="showpriscription()" style="cursor: pointer;">
						      <img src="popicons/view_account.png" alt="..." style="width: 64px; height: 64px;">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					...
					<h4 class="modal-title" id="myModalLabel">Client Did Not
						Attend</h4>
				</div>
				...
				<div class="row" style="margin-top: 5px;">
						<div class="col-lg-4 col-md-4 col-sm-4  col-md-5">Client Name :</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-lg-12 col-md-12">	
							Client : <span id="usclientdetailsid"> Mr. Tim Court, 302, High Street, COVENTRY, CV110JJ, DOB: 13/04/1977 </span>
						</div>
					</div>
...
<div class="modal fade" id="treatmentEpisodeCounterViewPopup" tabindex="-1" role="dialog"
 ...
 <!--Add Consultation Note Model-->
     <div class="modal fade" id="addConsultationNote" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
						  ...
						  <div class="panel panel-default">
						    <div class="panel-heading" role="tab" id="headingOne">
						      ...
						      <a role="button" data-toggle="collapse" data-parent="#accordion" href="#addcon1" aria-expanded="true" aria-controls="addcon1" style="color:#fff;">
						        ...
						        <a href="#"><i onclick="showpriscription()" title="Add Prescription" class="fa fa-plus-square fa-2x aadpres"></i></a>
						      </h4>
						    </div>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header bg-primary">
					...
					<h5 class="modal-title" id="priscmyModalLabel">Followups Reminder</h5>
				</div>
				<div class="modal-body">
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"
						onclick="insertPriscription(0)">Save</button>
						
						<button type="button" class="btn btn-primary"
						onclick="insertPriscription(1)">Save & Print</button>
				...
				<div class="modal-body">
				         ...
				         <div class="col-lg-12">
				         	<div class="col-lg-4">
								...
								<br><br><br><br><br>
								<!--<label> Select More Condition / Diagnosis</label>
						 	--></div>
						 	<div class="col-lg-8">
						        <s:form action="updateconNotAvailableSlot" method="post" id="demoform" theme="simple">
								 <s:select id = "modffycondition" name = "treatmentType" list="condtitionList" tabindex="115" headerValue="Select Condition" headerKey="0" listKey="id" listValue="treatmentType" cssClass="form-control showToolTip chosen amber"
									   ...
									   <div id="scroll">
									       <table id="innertable" width="100%">
									         ...
									         <!--<tr>
									          ...
									          <td><a href="#" onclick="" type="button"><i class="fa fa-trash"></i></a></td>
									         </tr>
