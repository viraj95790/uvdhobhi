...
function purchaseAjax(){
	...
	var url = "setPurchase?categoryD="+categoryD+"&subcategoryID="+tempsubcategoryid+"&quantity="+quantity+"&price="+price+"&viewsize="+viewsize+"&colorsize="+colorsize+"&gender="+gender+"";
