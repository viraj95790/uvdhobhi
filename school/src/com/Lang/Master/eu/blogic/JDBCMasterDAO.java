...
public class JDBCMasterDAO extends JDBCBaseDAO implements MasterDAO {
	...
	public ArrayList<Master> getStudeneNameList(String classid,String searchText) {
		PreparedStatement preparedStatement = null;
		ArrayList<Master>list = new ArrayList<Master>();
		StringBuffer sql = new StringBuffer();
		
		sql.append("select id,name,rollno,fathername,mothername,dob,address,mob from studentname where classid = "+classid+" ");
		
		if(!searchText.equals("")){
			sql.append("and name like('%"+searchText+"%') or rollno='"+searchText+"' ");
		}
	...
	public ArrayList<Master> getSubjectNameList(String terms) {
		...
		String sql = "SELECT id,name,displayname FROM subjectname where id in("+subjectid+") ";
	...
	public int createColumnName(String subjectname) {
	    ...
	    String sql = "ALTER TABLE marks ADD " + subjectname + " " + myColumnType;
	...
	public int updateMarks(String marks, String subjectname, int saveid) {
		...
		int result = 0;
		String sql = "update marks set "+subjectname+"="+marks+" where id="+saveid+" ";
	...
	public boolean checkTermExist(int id, String terms, String classid) {
		PreparedStatement preparedStatement = null;
		boolean result = false;
		String sql = "select * from marks where termid="+terms+" and studentid="+id+" and classid="+classid+" ";
	...
	public String getEnteredMarks(String terms, String classid, int studentid, String subjectname) {
		PreparedStatement preparedStatement =  null;
		String result = "";
		String sql = "select "+subjectname+" from marks where termid="+terms+" and studentid="+studentid+" and classid="+classid+"  ";
	...
	public ArrayList<Master> getTermNameList(String terms) {
		...
		String sql = "select id,name,outofmarks  from terms where termid = "+mastertermid+" ";
	...
	public double getSelectedStudentMarks(String classid, int studentid, int termid,String subjectname) {
		PreparedStatement preparedStatement = null;
		double result = 0;
		String sql = "SELECT "+subjectname+"  FROM marks where classid = "+classid+" and studentid = "+studentid+" and termid  = "+termid+" ";
	...
	public double gettotaltermsmarks(String termid) {
		...
		String sql = "select sum(outofmarks)  from terms where termid = "+mastertermid+" ";
	...
	public ArrayList<Master> getstudentdata(String clasid, String searchText) {
	    ...
	    sql.append("select id, name, rollno, dob, mob, category, classid from studentname where classid='"+clasid+"' ");
	    
	    if(searchText!=null){
			sql.append("and name like('%"+searchText+"%') or rollno='"+searchText+"' and classid='"+clasid+"' ");
		}
	...
	public Master getacademicyr(String terms) {
		...
		PreparedStatement preparedStatement = null;
		Master master = new Master();
		String sql = "select termid, acad_session from terms inner join master_terms on master_terms.id = terms.termid where terms.id ="+terms+" ";
		try {
			preparedStatement = connection.prepareStatement(sql);
			ResultSet rs = preparedStatement.executeQuery();
			while(rs.next()){
