package com.pacs.main.common.constants;
...
public class Constants {
	...
	public static final int PRIMARY_BILL = 1;
	
	public static final int SECONDARY_BILL = 2;
	
	public static final String CODECONSTANT = "123"; 
